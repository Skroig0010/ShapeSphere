...
abstract Vec3(Vec3Data) from Vec3Data to Vec3Data{
    ...
    inline function get_xy()return new Vec2(this.x, this.y);
    inline function get_xz()return new Vec2(this.x, this.z);
    inline function get_yz()return new Vec2(this.y, this.z);
    inline function get_yx()return new Vec2(this.y, this.x);
    inline function get_zx()return new Vec2(this.z, this.x);
    inline function get_zy()return new Vec2(this.z, this.y);
